...
const StudentReverse: React.FC<StudentProps> = ({ image, student_user }) => {
  ...
  return (
    <div className="flex justify-center items-center mb-48 mt-32">
      <div className="flex  relative justify-end mr-16 rounded-[40px] hover:bg-black/80 group hover:scale-105 ease-in duration-500">
        <Image src={image} alt="foto" className="rounded-[40px] w-72 group-hover:opacity-10" width={80} height={80} />
