    ...
    <div className="flex justify-center items-center mb-48 md:mt-32  w-full">
      <div>
        <div className="flex flex-row lg:ml-48">
          <div className="flex relative justify-center md:mr-16 mr-4 rounded-[40px] hover:bg-black/80 group hover:scale-105 ease-in duration-500 flex-col ml-4">
            <Image
              src={image}
              alt="foto"
              className="rounded-[40px] w-48 md:w-[220px] lg:w-72  group-hover:opacity-10"
              width={80}
              height={80}
            />
          </div>
